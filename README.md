...
> This is one of the many Capstone Projects includeed in The Odin Project curriculum

**[ Recipes ]** is the first Capstone project as part of the Foundations Course at the The Odin Project Fullstack Curriculum ans is aimed to apply all the HTML foundations learned in the Foundations course.
...
- https://cuauh-cabrera.github.io/odin-recipes/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/-odin-recipes.git
```
